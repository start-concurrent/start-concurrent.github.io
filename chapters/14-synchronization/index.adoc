...
[[program:RaceCondition, RaceCondition]]
----
...
implementation in <<example:Bank_account>> for the bank account.
...
implementation of matrix multiply given in <<example:Matrix
...
<<example:Deadlock_sum>>. Explain why this example fulfills all
...
10. [[exercise14.10]] In
<<example:Producer/consumer>> the `Buffer` class used to
...
11. [[exercise14.11]] In <<example:Bank_account>>
