...
In <<Selection>>, you learned tools that allow you to do
...
.Binary Conversion
====
As we discussed in <<Computer Basics>>, binary numbers
...
In <<Concurrent Programming>>, we will introduce tools
...
which we will cover in in <<Concurrent Programming>>. As
...
****
<<exercise5.15, Exercise 5.15>>
****

=== Exercises
*Conceptual Problems*

1.  [[exercise5.1]] If you have a `String` containing a long text and you want to count
the number of words in the text that begin with the letter `'m'`, which
of the three kinds of loops would you use, and why?
2.  [[exercise5.2]] In <<example:Primality_testing>>,
...
----
3. [[exercise5.3]] How many different DNA sequences of length latexmath:[n] are
there?
4. [[exercise5.4]] There are three different errors in the following loop intended to
...
----
5. [[exercise5.5]]  Consider the following code containing nested `for` loops.
+
[source,java]
----
Scanner in = new Scanner(System.in);
...
6.  [[exercise5.6]] Write a program that converts base 10 numbers into base 3 numbers.
...
7.  [[exercise5.7]] The greatest common divisor (GCD) of two integers is the largest
...
8.  [[exercise5.8]] In the solution to the DNA searching
...
9.  [[exercise5.9]] Write a program that reads a number latexmath:[n] from a user and
...
10. [[exercise5.10]] Re-implement the solution to the DNA searching program given in
<<Solution: DNA searching>> using `JOptionPane` to generate GUIs
for input and output.
+
*Experiments*
11. [[exercise5.11]] Using a `for` loop, record the Monty Hall simulation so that you can
...
12. [[exercise5.12]] Write three nested `for` loops, each of which run 1,000 times.
...
13. [[exercise5.13]] In <<subsection:common_pitfalls>>, one of the common loop
...
an `int`?
14. [[exercise5.14]] In <<example:Primality_testing>>, we gave three programs to
...
`PrimalityTester2`?
15. [[exercise5.15]] In <<example:Parallelism
