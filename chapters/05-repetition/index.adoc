...
==== Begin Example: Binary Conversion
...
==== Begin Example: DNA reverse complement
...
==== Begin Pitfall: Almost infinite loops
...
==== Begin Pitfall: Fencepost errors
...
==== Begin Pitfall: Misplaced semicolons
...
==== Begin Example: Parallelism without threads
