...
This sines example is similar to <<arraySummationExample>>
...
2.  [[exercise5.2]] In <<primalityTestingExample>>,
...
13. [[exercise5.13]] In <<Common pitfalls>>, one of the common loop
...
an `int`?
14. [[exercise5.14]] In <<primalityTestingExample>>, we gave three programs to
...
`PrimalityTester2`?
15. [[exercise5.15]] In <<parallelismWithoutThreadsExample>>, we ran four programs at the same time to solve a
