...
Defining classes as we did in <<Classes>> provides us
...
<<Inheritance>>, we will talk about hierarchical
...
As we discussed in <<example:Selection_sort>>, sorting is one of
...
[[program:Guitarist, Guitarist]]
----
include::programs/Guitarist.java[]
----
...
[source, java, linenums]
[[program:RockGuitarist, RockGuitarist]]
----
include::programs/RockGuitarist.java[]
----
...
[source, java, linenums]
[[program:ClassicalGuitarist, ClassicalGuitarist]]
----
include::programs/ClassicalGuitarist.java[]
----
...
[source, java, linenums]
[[program:StaticGuitarist, StaticGuitarist]]
----
include::programs/StaticGuitarist.java[]
----
...
[source, java, linenums]
[[program:ConstantGuitarist, ConstantGuitarist]]
----
include::programs/ConstantGuitarist.java[]
----
...
[source, java, linenums]
[[program:Priceable, Priceable]]
----
include::programs/Priceable.java[]
----
...
[source, java, linenums]
[[program:Bananas, Bananas]]
----
include::programs/Bananas.java[]
----
...
If you have not read <<Advanced: Nested classes>>, you may want
...
[source, java, linenums]
[[program:AreaGettable, AreaGettable]]
----
include::programs/AreaGettable.java[]
----
...
`AreaGettable`. As in <<example:Supermarket_pricing>>, we used
...
in <<example:Supermarket_pricing>> to sorting them. Refer to the
...
[source, java, linenums]
[[program:Ageable, Ageable]]
----
include::programs/Ageable.java[]
----


[source, java, linenums]
[[program:Weighable, Weighable]]
----
include::programs/Weighable.java[]
----
...
We’ll see in <<Inheritance>> that the `Dog`, `Cat`, and
...
cover generics in <<Dynamic Data Structures>>.
...
In <<Synchronization>>, we will discuss a key way to
...
1. [[exercise10.1]] What is the purpose of an interface?
2. [[exercise10.2]] Why implement an interface when it puts additional requirements on a
class yet adds no functionality?
3. [[exercise10.3]] Is it legal to have methods marked `private` or `protected` in an
interface? Why did the designers of Java make this choice?
4. [[exercise10.4]] What is the `instanceof` keyword used for? Why is it useful in the
context of interfaces?
5. [[exercise10.5]] What kind of programming error causes a `ClassCastException`?
6. [[exercise10.6]] Create an interface called `ColorWavelengths` that only contains
...
|Violet |415
|======================
7. [[exercise10.7]] Write an interface called `Clock` that specifies the functionality a
...
that you specify.
8. [[exercise10.8]] There are four compiler errors in the following interface. Name each
...
----
9. [[exercise10.9]] Consider the interface defined below.
+
[source,java]
----
...
----
10. [[exercise10.10]] Write a single class that correctly implements the following three
interfaces.
+
[source,java]
----
...
----
11. [[exercise10.11]] If you are sorting a list of items latexmath:[n] elements long
...
12. [[exercise10.12]] Add client code that randomly creates the objects needing sorting in
...
13. [[exercise10.13]] Refer to the sort given as a solution in <<Solution: Sort it
...
14. [[exercise10.14]] After learning about threads in
<<Concurrent Programming>>, refer to the simple bubble
...
+
*Experiments*
15. [[exercise10.15]] Once you have implemented the sort in parallel from
<<exercise10.14, Exercise 10.14>>, time it against the sequential
