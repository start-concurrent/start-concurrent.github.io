...
SPGMFILE: ClassicalGuitarist.java
...
SPGMFILE: ConstantGuitarist.java
...
SPGMFILE: Ageable.java

SPGMFILE: Weighable.java
...
SPGMFILE: Person.java

SPGMFILE: Cheese.java
