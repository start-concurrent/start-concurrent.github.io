...
<<exercise2.10, Exercise 2.10>> asks you to calculate
these times for the sequential and concurrent approaches.

****
<<exercise2.10, Exercise 2.10>>
****
...
1.  [[exercise2.1]] When solving a problem using a
...
2.  [[exercise2.2]] In Example <<example:Input for
...
statement.
5.  [[exercise2.5]] Is the following
...
the compiler.
9.  [[exercise2.9]] Explain the difference
...
13. [[exercise2.13]] Write a program that prompts the user
...
`System.out.println()`.
14. [[exercise2.14]] Expand the program from
...
`System.out.print()`.
16. [[exercise2.16]] Copy and paste
...
`System.out.print()`.
18. [[exercise2.18]] In Example <<example:Input
...
19. [[exercise2.19]] A program can use both a command
