...
stem:[[s_{n-1} s_{n-2} \ldots s_1 s_0=s_{n-1}\times b^{n-1}+ s_{n-2}\times b^{n-2}+
...
stem:[[0.s_{1} s_{2} \ldots s_{n-2} s_{n-1}=s_{1}\times b^{-1}+ s_{2}\times b^{-2}+
...
stem:[[10011 = 1 \times 2^4+0 \times 2^3+0 \times 2^2+1 \times 2^1+1 \times
2^0=16+0+0+2+1 = 19]]
...
stem:[[\mathrm{A} \times 16^3+0 \times 16^2+ \mathrm{B} \times 16^1+ \mathrm{F} \times
16^0]]
...
stem:[[10 \times 16^3+0 \times 16^2+11 \times 16^1+15 \times 16^0=40960+0+176+15=41151]]
...
stem:[[377=3 \times 8^2+7 \times 8^1+7 \times 8^0=255]]
...
stem:[[23=16+0+4+2+1=1\times 2^4+0\times 2+3+1\times 2+2+1\times 2+1+1\times 2^0= 10111_2]]
...
multiplications by 2. Consider stem:[11 << 3]. The representation
...
Consider stem:[-104 >> 2]. The representation
...
stem:[1]. Consider stem:[\complement(-104)]. The
...
[cols="<,<,<,<,<",options="header",]
|=======================================================================
|*Step* |*stem:[f]* |*stem:[f \times 2]* |*Integer part*
|*Remainder*
...
stem:[[0.1101=1\times 2^{-1}+1\times2^{-2}+0\times 2^{-3}+1\times
...
stem:[[0.01001=0\times2^{-1}+1\times 2^{-2}+ 0\times2^{-3}+ 0\times 2^{-4}+ 1\times
...
NOTE: Left off here, although work remains on the tables preceding this location.
...
|32-bit integer |stem:[2,147,483,647]
|stem:[-2,147,483,648]

|64-bit integer |stem:[9,223,372,036,854,775,807]
|stem:[-9,223,372,036,854,775,808]
...
a.  stem:[\mathrm{A}2\mathrm{F}_{16} + \mathrm{BB}_{16} =] +
b.  stem:[32\mathrm{C}_{16} + \mathrm{D}11\mathrm{F}_{16} =] +
...
Let stem:[a, b] and stem:[c] denote three real numbers.
...
a.  stem:[( a + b )+ c = a + ( b + c )]
b.  stem:[a+b=b+a]
c.  stem:[a \times b=b \times a]
d.  stem:[a+0=a]
e.  stem:[(a\times b)\times c=a\times (b\times c)]
f.  stem:[a\times (b+c)=(a\times b)+(a\times c)]
