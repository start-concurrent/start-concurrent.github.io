...
image::yes-noDialogFigure.svg[opts=inline,scaledwidth=100%,pdfwidth=100%,width=100%]
...
image::inputDialogFigure.png[scaledwidth=50%,pdfwidth=50%,width=50%]
