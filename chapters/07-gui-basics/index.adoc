...
few built-in Java classes. Chapter <<chapter:Constructing_Graphical_User_Interfaces>> introduces more advanced tools for constructing complex
GUIs.
...
The GUIs we will create in Chapter <<chapter:Constructing_Graphical_User_Interfaces>>, however, will be more than dialogs. They will be fully
