...
[source, java]
----
include::programs/MathTutorApplet.java[lines=1..17]
----
...
[source, java]
----
include::programs/MathTutorApplet.java[lines=19..52]
----
...
[source, java]
----
include::programs/MathTutorApplet.java[lines=54..67]
----
...
[source, java]
----
include::programs/MathTutorApplet.java[lines=69..95]
----
...
panel is visible?
18. [[exercise15.18]] Remove the line `frame.setResizable(false);` from <<FlowLayoutExampleProgram>>. Run the modified program and
