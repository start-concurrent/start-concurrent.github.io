...
the same summation is discussed in <<The for-each loop>>.
...
8.  [[exercise6.8]] In <<wordSearchExample>>,
...
9.  [[exercise6.9]] In <<wordSearchExample>>, we
...
10. [[exercise6.10]] In <<statisticsExample>>, we gave a program that finds the
