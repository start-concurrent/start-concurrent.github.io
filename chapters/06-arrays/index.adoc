...
image::array.svg[scaledwidth=100%,pdfwidth=100%,width=100%]
...
image::split1.svg[scaledwidth=60%,pdfwidth=60%,width=60%]
...
image::split2.svg[scaledwidth=60%,pdfwidth=60%,width=60%]
