...
SPGMFILE: ColorUnderflowException.java

SPGMFILE: ColorOverflowException.java
...
SPGMFILE: BurglarAlarmException.java

SPGMFILE: WatchmanException.java

SPGMFILE: LockPickFailException.java

SPGMFILE: LootTooHeavyException.java
