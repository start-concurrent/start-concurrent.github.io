...
<<Arrays>>, we used the `Thread.sleep()` method to put
...
****
<<exercise12.5, Exercise 12.5>> +
<<exercise12.8, Exercise 12.8>>
****

In <<Arrays>>, there were no executable statements in
...
****
<<exercise12.3, Exercise 12.3>> +
<<exercise12.4, Exercise 12.4>>
****
...
****
<<exercise12.2, Exercise 12.2>> +
<<exercise12.9, Exercise 12.9>> +
<<exercise12.11, Exercise 12.11>>
****
...
****
<<exercise12.12, Exercise 12.12>> +
<<exercise12.13, Exercise 12.13>> +
<<exercise12.14, Exercise 12.14>>
****
...
----
include::programs/QuickCalculator.java[lines=1..14]
----
...
[source, java, linenums]
----
include::programs/QuickCalculator.java[lines=15..30]
----
...
[source, java, linenums]
[[program:ColorUnderflowException, ColorUnderflowException]]
----
include::programs/ColorUnderflowException.java[]
----


[source, java, linenums]
[[program:ColorOverflowException, ColorOverflowException]]
----
include::programs/ColorOverflowException.java[]
----
...
[source, java, linenums]
[[program:BurglarAlarmException, BurglarAlarmException]]
----
include::programs/BurglarAlarmException.java[]
----


[source, java, linenums]
[[program:WatchmanException, WatchmanException]]
----
include::programs/WatchmanException.java[]
----


[source, java, linenums]
[[program:LockPickFailException, LockPickFailException]]
----
include::programs/LockPickFailException.java[]
----


[source, java, linenums]
[[program:LootTooHeavyException, LootTooHeavyException]]
----
include::programs/LootTooHeavyException.java[]
----
...
[source, java, linenums]
----
include::programs/Henchman.java[lines=1..13]
----
...
[source, java, linenums]
----
include::programs/Henchman.java[lines=14..37]
----
...
.This program spawns 10 threads. 9 out of 10 spawned threads as well as the main thread throw an exception and die. The remaining thread outputs the sum of the sines of 1 through 1,000,000.
[source, java, linenums]
[[program:CrazyThread, CrazyThread]]
----
include::programs/CrazyThread.java[]
----
...
1.  [[exercise12.1]] What are the advantages of
using exceptions instead of returning error codes?
2.  [[exercise12.2]] The keywords `final` and `finally`,
as well as the `Object` method `finalize()`, are sometimes confused.
What is the purpose of each one?
3.  [[exercise12.3]] What is the difference between the
`throw` keyword and the `throws` keyword?
4.  [[exercise12.4]] Explain the catch or specify
requirement of Java.
5.  [[exercise12.5]] What must be done differently
...
6.  [[exercise12.6]] For every program you write, you
...
7.  [[exercise12.7]] Why did the designers of Java choose to make `NullPointerException`
and +
...
8.  [[exercise12.8]] Consider the following two classes.
+
[source,java]
----
...
9.  [[exercise12.9]] What value will the following method
...
----
10. [[exercise12.10]] Why will the following
...
----
11. [[exercise12.11]] Consider the following fragment of
Java.
+
[source,java]
----
...
12. [[exercise12.12]] The `NumberFormatException`
...
13. [[exercise12.13]] Refer to
<<exercise11.14, Exercise 11.14>> and add to the basic mechanics of the simulation by designing two custom
...
14. [[exercise12.14]] Users often log onto systems by
...
+
*Experiments*
15. [[exercise12.15]] Throwing and catching exceptions
