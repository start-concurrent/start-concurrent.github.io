...
SPGMFILE: Racecar.java

SPGMFILE: TurboRacecar.java
...
SPGMFILE: StaticRacecar.java

SPGMFILE: StaticTurboRacecar.java
...
SPGMFILE: Vehicle.java

SPGMFILE: RocketShip.java
...
SPGMFILE: ArithmeticSequence.java

SPGMFILE: GeometricSequence.java
