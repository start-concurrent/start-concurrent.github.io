...
In <<Synchronization>>, we introduced the
...
In <<Inheritance>> you were exposed to concepts in
...
[[program:Racecar, Racecar]]
----
include::programs/Racecar.java[]
----


[source, java, linenums]
[[program:TurboRacecar, TurboRacecar]]
----
include::programs/TurboRacecar.java[]
----
...
[source, java, linenums]
[[program:StaticRacecar, StaticRacecar]]
----
include::programs/StaticRacecar.java[]
----


[source, java, linenums]
[[program:StaticTurboRacecar, StaticTurboRacecar]]
----
include::programs/StaticTurboRacecar.java[]
----
...
[source, java, linenums]
[[program:Vehicle, Vehicle]]
----
include::programs/Vehicle.java[]
----


[source, java, linenums]
[[program:RocketShip, RocketShip]]
----
include::programs/RocketShip.java[]
----
...
[source, java, linenums]
[[program:Useless, Useless]]
----
include::programs/Useless.java[]
----
...
[source, java, linenums]
[[program:Useful, Useful]]
----
include::programs/Useful.java[]
----
...
----
include::programs/Sequence.java[]
----
...
[source, java, linenums]
[[program:ArithmeticSequence, ArithmeticSequence]]
----
include::programs/ArithmeticSequence.java[]
----


[source, java, linenums]
[[program:GeometricSequence, GeometricSequence]]
----
include::programs/GeometricSequence.java[]
----
...
[source, java, linenums]
----
include::programs/BankAccount.java[lines=1..1]
----
...
[source, java, linenums]
----
include::programs/BankAccount.java[lines=3..6]
----
...
[source, java, linenums]
----
include::programs/BankAccount.java[lines=8..19]
----
...
[source, java, linenums]
----
include::programs/BankAccount.java[lines=21..36]
----
...
[source, java, linenums]
----
include::programs/BankAccount.java[lines=38..49]
----
...
[source, java, linenums]
[[program:Mammal, Mammal]]
----
include::programs/Mammal.java[]
----
...
[source, java, linenums]
[[program:Platypus, Platypus]]
----
include::programs/Platypus.java[]
----
...
[source, java, linenums]
[[program:DavidBowie, DavidBowie]]
----
include::programs/DavidBowie.java[]
----
...
[source, java, linenums]
[[program:CheckingAccount, CheckingAccount]]
----
include::programs/CheckingAccount.java[]
----
...
[source, java, linenums]
[[program:DirectDepositAccount, DirectDepositAccount]]
----
include::programs/DirectDepositAccount.java[]
----
...
[source, java, linenums]
[[program:SavingsAccount, SavingsAccount]]
----
include::programs/SavingsAccount.java[]
----
...
Program <<program:RaceCondition>> that even an operation as simple as
...
Program <<program:RaceCondition>> so that no race condition occurs.

.Program to demonstrate the use of `AtomicInteger`.
[source, java, linenums]
[[program:NoRaceCondition, NoRaceCondition]]
----
include::programs/NoRaceCondition.java[]
----

This program is identical to Program <<program:RaceCondition>>, except
...
****
<<exercise17.11, Exercise 17.11>>
****

=== Exercises
*Conceptual Problems*

1. [[exercise17.1]] Consider the following two classes:
+
[source, java, linenums]
[[program:Sale, Sale]]
----
include::programs/Sale.java[]
----

+
[source, java, linenums]
[[program:Blowout, Blowout]]
----
include::programs/Blowout.java[]
----
...
System.out.println( sale.discount );
----
2. [[exercise17.2]] What are the differences and similarities between abstract classes
and interfaces?
3. [[exercise17.3]] Assume that the `Corn`, `Carrot`, and `Potato` classes are all
...
----
4. [[exercise17.4]] How many different meanings of the keyword `final` are there in
Java, and what does each mean?
5. [[exercise17.5]]  Assume that `Quicksand` is a subclass of `Danger`.
+
...
6. [[exercise17.6]] Implement a program to assess income tax on normal employees,
...
7. [[exercise17.7]] Refer to the sort given in <<Solution: Sort it out>> as the
...
functionality.
8.  [[exercise17.8]] Again refer to the sort from
...
9. [[exercise17.9]] Re-implement the original
`SynchronizedAccount` class from <<example:Bank_account>> using
...
+
*Experiments*
10. [[exercise17.10]] Once you have implemented the sort in parallel from
<<exercise17.8, Exercise 17.8>>, time it against the
...
expect?
11. [[exercise17.11]] Take Program <<program:NoRaceCondition>>
and increase `COUNT` to `100000000`. Run it several times and time how
long it takes to run to completion.
+
Then, take Program <<program:RaceCondition>> and increase its `COUNT` to
