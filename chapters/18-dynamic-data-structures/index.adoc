...
after the operands it works on. Table <<table:infix_and_postfix>> gives
...
==== Begin Example: Postfix computation
...
==== Begin Example: Defining a generic linked list
