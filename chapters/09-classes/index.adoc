...
image::nested.svg[scaledwidth=100%,pdfwidth=100%,width=100%]
...
image::inner.svg[scaledwidth=100%,pdfwidth=100%,width=100%]
...
9.  In Section REF=solution:Nested expressions, we gave a definition of
...
14. Re-implement the solution from Section REF=solution:Nested
