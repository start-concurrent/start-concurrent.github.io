...
==== Begin Example: Simple client and server
...
==== Begin Example: Chat client and server
...
from Chapter <<chapter:Constructing_Graphical_User_Interfaces>>, you can
...
----
include::programs/Chat.java[lines=1..14]
----
...
[source, java, linenums]
----
include::programs/Chat.java[lines=16..24]
----
...
[source, java, linenums]
----
include::programs/Chat.java[lines=26..34]
----
...
[source, java, linenums]
----
include::programs/Chat.java[lines=36..43]
----
...
[source, java, linenums]
----
include::programs/Chat.java[lines=45..69 *FIX: Chat program listing, lines]
----
...
[source, java, linenums]
----
include::programs/Chat.java[lines=71..83]
----
...
[source, java, linenums]
----
include::programs/WebServer.java[lines=1..23]
----
...
[source, java, linenums]
----
include::programs/WebServer.java[lines=25..63]
----
...
[source, java, linenums]
----
include::programs/WebServer.java[lines=65..72]
----
...
[source, java, linenums]
----
include::programs/WebServer.java[lines=74..104]
----
...
Even in Example <<example:Chat_client_and_server>>, it was convenient to
...
2.  Explain the difference between client and server computers in
network communication. Is it possible for a single computer to be both a
client and a server?
3.  Why is writing a web browser so much more complicated than writing a
web server?
4.  Name and briefly describe the seven layers of the OSI model.
5.  Modern computers often have many programs running that are all in
...
6.  What are the most popular choices of protocols at the transport
layer of the OSI model? What are the advantages and disadvantages of
each?
7.  How many possible IP addresses are there in IPv4? IPv6 addresses are
...
8.  Recall the client and server from Section <<subsection:receiving and
...
9.  <<exercise:chat_GUI>> Add a GUI based on `JFrame` for the chat
program given in Example <<example:Chat_client_and_server>>. Use a
...
10. <<exercise:multi-threaded_web_server>> Study the web server
implementation from Section <<solution:Web_server>>. Implement a similar
...
11. <<exercise:thread_pool_web_server>> One of the weaknesses of the web
...
+
*Experiments*
12. Consider the multi-threaded implementation of a web server from
Exercise <<exercise:multi-threaded_web_server>>. Can you design an
