...
1.  [[exercise19.1]] <<multiplicationDefinedRecursivelyExample>> gave a mathematical recursive definition for
...
<<exponentiationExample>> except when latexmath:[n] is odd.
...
\end{cases}]
8.  [[exercise19.8]] <<fibonacciImplementedRecursivelyExample>> shows two implementations that can be used to
...
9.  [[exercise19.9]] <<recursiveLinkedListSizeExample>> shows a way to calculate the size of a linked list
