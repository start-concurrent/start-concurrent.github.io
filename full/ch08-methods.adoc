...
If you're unfamiliar with poker rules or card games in general, here is
...
as `Math.sqrt()`. The expression stem:[f(x) = \sqrt{x}] defines
...
Given a two points in 3D space stem:[(x_1, y_1, z_1)] and
stem:[(x_2,
