...
before printing.
<.> Then, it increments to the next odd number afterwards.
...
scientific notation, such as `7.239e-14`.  Note that the `e` can be upper case
or lower case, and the exponent can begin with a minus sign (`-`), a plus sign (`+`),
or neither.
