...
[#exercise1-6, start=6, reftext="Exercise 1.6"]
...
[#exercise1-9, start=9, reftext="Exercise 1.9"]
...
[#exercise1-10, start=10, reftext="Exercise 1.10"]
. Create a table that lists the binary equivalents of octal digits, similar to the one in <<Other conversions>>. Hint: Each octal digit can be represented as a sequence of three binary digits.

[#exercise1-11, start=11, reftext="Exercise 1.11"]
...
[#exercise1-14, start=14, reftext="Exercise 1.14"]
...
[#exercise1-15, start=15, reftext="Exercise 1.15"]
...
[#exercise1-16, start=16, reftext="Exercise 1.16"]
...
[#exercise1-17, start=17, reftext="Exercise 1.17"]
...
[#exercise1-18, start=18, reftext="Exercise 1.18"]
. Expand <<Non-terminating_fraction>> assuming that you have ten bits to represent the
fraction. Convert the representation back to base 10. How far off is
this value from 0.3?

[#exercise1-19, start=19, reftext="Exercise 1.19"]
. Will the process in <<Non-terminating fraction>> ever terminate assuming that we can use as
many bits as needed to represent 0.3 in binary?

[#exercise1-20, start=20, reftext="Exercise 1.20"]
...
[#exercise1-23, start=23, reftext="Exercise 1.23"]
