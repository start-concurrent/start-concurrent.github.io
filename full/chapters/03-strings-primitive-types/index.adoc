...
http://download.oracle.com/javase/7/docs/api/java/util/Formatter.html#syntax[Formatter documentation^].
...
http://download.oracle.com/javase/7/docs/api/java/lang/String.html[String documentation^] for a
...
http://download.oracle.com/javase/7/docs/api/java/lang/Math.html[Math documentation^].
...
[source, java]
----
include::programs/CollegeCosts.java[lines=8..22]
----
...
[source, java]
----
include::programs/CollegeCosts.java[lines=23..29]
----
...
[source, java]
----
include::programs/CollegeCosts.java[lines=30..42]
----
...
<4> We start the second thread running. Every object whose type is `Thread` (or a child of `Thread`, which we will discuss in <<Inheritance>>) has a `start()` method which begins its execution as a separate thread.
