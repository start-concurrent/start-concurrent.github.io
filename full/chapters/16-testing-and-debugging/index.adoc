...
will be discussed at length in <<Polymorphism>>. The
...
discussed in <<Dynamic Data Structures>>, can reduce the
...
[[BodybuilderProgram]]
----
include::programs/Bodybuilder.java[]
----
...
----
include::programs/BraggingBodybuilder.java[]
----
...
<<Synchronization>>. Except in the case of deadlocks and
...
1. [[exercise16.1]] What is the purpose of the `assert` keyword in Java? What steps must
be taken for it to be active?
2. [[exercise16.2]] What is the value of `j` after the following statements are
executed?
+
[source,java]
----
...
3. [[exercise16.3]] The following loop is intended to print out all possible `byte`
...
----
4. [[exercise16.4]] What are all the possible run-time errors that could occur in this
...
5. [[exercise16.5]] Consider the following definition of a stack that holds `int`
values.
+
[source,java]
----
...
be thrown?
6. [[exercise16.6]] This question sometimes comes up in job interviews. Imagine that you
have a simple singly linked list such as the one described in
<<Dynamic Data Structures>>. What if there is a loop in
...
execution?
7. [[exercise16.7]] What is the difference between black box testing and white box
testing? What kinds of bugs are more likely to be caught by black box
testing? By white box testing?
8. [[exercise16.8]] The Microsoft Zune is a portable media player in competition with
...
9.  [[exercise16.9]] Apply JUnit testing to the last major assignment you did in class.
What bugs did you uncover?
+
*Experiments*
10. [[exercise16.10]] James Gosling's original specification for Java contained
...
11. [[exercise16.11]] Take another look at your last programming assignment. Calculate the
...
12. [[exercise16.12]] Take a concurrent program you have written that relies on explicit
