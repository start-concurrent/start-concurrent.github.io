...
. [[exercise6.1]] Why can't an array be used to hold an arbitrarily long list of
numbers entered by a user? What are strategies that can be used to
overcome this problem?
. [[exercise6.2]] In future chapters, we will introduce a data structure called a
...
. [[exercise6.3]] Given the following code:
+
[source,java]
----
...
executed?
. [[exercise6.4]] What error will be caused by the following code, and why?
+
[source,java]
----
...
----
. [[exercise6.5]] An array of length latexmath:[n] in Java typically takes
...
.  [[exercise6.6]] Our original table of city distances allocates
...
.  [[exercise6.7]] Consider the naive method of dividing
...
[start=8]
.  [[exercise6.8]] In <<wordSearchExample>>,
...
.  [[exercise6.9]] In <<wordSearchExample>>, we
...
. [[exercise6.10]] In <<statisticsExample>>, we gave a program that finds the
...
. [[exercise6.11]] We used the example of Tic Tac Toe in
...
. [[exercise6.12]] Once you have mastered the material in
...
*Experiments*
[start=13]
. [[exercise6.13]] Creating arrays with longer and longer lengths requires more
...
memory being used.
. [[exercise6.14]] Run the implementation of the word search program using the binary
...
. [[exercise6.15]] Generate input files consisting of 1,000,
