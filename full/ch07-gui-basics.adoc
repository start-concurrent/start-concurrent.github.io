...
<<inputDialogFigure>>(a) shows the dialog generated by <<ChemistryQuizOneProgram>>.
====
...
<.> The `toUpperCase()` method converts the `String` to upper case, allowing us to read input in either case.
