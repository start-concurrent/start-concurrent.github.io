...
we will test on bitmaps. The idea behind RLE is simple: Imagine a file as a
...
are the ASCII representation of the four bytes of the number 2,127,480,645.

In some sense, the idea of a text file is artificial. All files are
binary in the sense that they are readable by a computer. You'll take
...
example with the integer 2,127,480,645, can often be stored more compactly.
