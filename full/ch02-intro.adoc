...
<<ex2-10, Exercise 2.10>> asks you to calculate
these times for the sequential and concurrent approaches.

****
<<ex2-10, Exercise 2.10>>
****
...
1.  [[ex2-1]] When solving a problem using a
...
2.  [[ex2-2]] In <<DistanceProgram>>, we declared all variables to be of type
...
13. [[ex2-13]] Write a program that prompts the user
...
`System.out.println()`.
14. [[ex2-14]] Expand the program from
<<ex2-13,Exercise 2.13>> so that it finds the average of
...
15. Rewrite your solution to <<ex2-14,Exercise 2.14>> so
that it uses a `JOptionPane`-based GUI instead of `Scanner` and
`System.out.print()`.
16. [[ex2-16]] Copy and paste
...
17. Rewrite your solution to <<ex2-16,Exercise 2.16>>
so that it uses a `JOptionPane`-based GUI instead of `Scanner` and
`System.out.print()`.
18. [[ex2-18]] In <<inputForDistanceComputationExample>>, we assumed that the speed is given in miles
...
19. [[ex2-19]] A program can use both a command
