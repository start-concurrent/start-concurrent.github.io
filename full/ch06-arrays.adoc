...
Your problem is to create a Life simulator of size stem:[n \times m],
...
image::array.svg[scaledwidth=75%,pdfwidth=75%,width=75%]
...
image::array2.svg[scaledwidth=75%,pdfwidth=75%,width=75%]
...
of the array is stem:[n], we'll need to look for the smallest
...
image::array3.svg[scaledwidth=75%,pdfwidth=75%,width=75%]
...
We're going to create a calendar that can be printed to the console to
...
vector.
<2> Afterwards, it reads three values from the user into it.
