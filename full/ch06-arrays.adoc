...
1. [[ex6-1]] Why can't an array be used to hold an arbitrarily long list of
numbers entered by a user? What are strategies that can be used to
overcome this problem?
2. [[ex6-2]] In future chapters, we will introduce a data structure called a
...
3. [[ex6-3]] Given the following code:
+
[source,java]
----
...
executed?
4. [[ex6-4]] What error will be caused by the following code, and why?
+
[source,java]
----
...
----
5. [[ex6-5]] An array of length latexmath:[n] in Java typically takes
...
6.  [[ex6-6]] Our original table of city distances allocates
...
7.  [[ex6-7]] Consider the naive method of dividing
...
9.  [[ex6-9]] In <<wordSearchExample>>, we
...
10. [[ex6-10]] In <<statisticsExample>>, we gave a program that finds the
...
11. [[ex6-11]] We used the example of Tic Tac Toe in
...
12. [[ex6-12]] Once you have mastered the material in
...
+
*Experiments*
13. [[ex6-13]] Creating arrays with longer and longer lengths requires more
...
memory being used.
14. [[ex6-14]] Run the implementation of the word search program using the binary
search improvement from <<ex6-9, Exercise 6.9>>. Use the OS
...
15. [[ex6-15]] Generate input files consisting of 1,000,
