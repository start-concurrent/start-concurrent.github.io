...
[.text-center]
image::deviation.svg[scaledwidth=25%,pdfwidth=25%,width=25%]
...
[.text-center]
image::matrix.svg[scaledwidth=20%,pdfwidth=20%,width=20%]
...
[.text-center]
image::vector.svg[scaledwidth=20%,pdfwidth=20%,width=20%]
