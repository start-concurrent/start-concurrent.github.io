...
<<ex18-12, Exercise 18.12>> explores the need to
synchronize these methods in the presence of multiple threads.

****
<<ex18-9, Exercise 18.9>> +
<<ex18-12, Exercise 18.12>>
****
