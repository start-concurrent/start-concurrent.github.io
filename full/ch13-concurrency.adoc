...
5.  [[ex13-5]] Suppose that a computer has one
...
6.  [[ex13-6]] Consider the definition of speedup from
...
9.  [[ex13-9]] Consider the following table of
tasks:
+
...
10. [[ex13-10]] Consider the following code snippet.
+
[source,java]
----
x = 13;
...
11. [[ex13-11]] Re-implement the array summing problem from
...
with the technique.
12. [[ex13-12]] Composers often work with multiple tracks
...
13. [[ex13-13]] Write a program which takes a number of
...
+
*Experiments*
15. [[ex13-15]] Use the `currentTimeMillis()` method
...
16. [[ex13-16]] Thread creation overhead is an
...
17. [[ex13-17]] Create serial and concurrent
...
18. [[ex13-18]] Repeatedly run the code in
...
19. [[ex13-19]] Create serial and parallel implementations of
...
first?
20. [[ex13-20]] The solution to the array summing problem in
