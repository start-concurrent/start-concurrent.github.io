...
[source, java, linenums]
----
include::{programsdir}/Student.java[lines=1..6]
----
...
[source, java, linenums]
----
include::{programsdir}/Student.java[lines=8..12]
----
...
[source, java, linenums]
----
include::{programsdir}/Student.java[lines=14..22]
----
...
[source, java, linenums]
----
include::{programsdir}/Student.java[lines=24..32]
----
...
[source, java, linenums]
----
include::{programsdir}/NestedExpressions.java[lines=10..37]
----
...
[source, java, linenums]
----
include::{programsdir}/NestedExpressions.java[lines=39..47]
----
...
is discussed in <<ch12-exceptions#ch12-exceptions>>. Some critics of Java
...
<<ch13-concurrency#ch13-concurrency>>, we discuss how to create
...
In <<ch14-synchronization#ch14-synchronization>>, we discuss how to prevent this
...
and manipulate `int` values. In <<ch18-dynamic-data-structures#ch18-dynamic-data-structures>>, we talk about the `ArrayList` and `Vector` classes, which
