...
. What is the meaning of the `this` keyword? When is it necessary to
...
used to manipulate an stem:[(x,y)] pair in programs involving the
...
stem:[\sqrt{(x_1 - x_2)^2+(y_1 - y_2)^2}] to find the distance
