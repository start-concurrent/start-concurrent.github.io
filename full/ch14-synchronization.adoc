...
.  [[synchronizedKeywordExercise]] What is the purpose of the
...
.  [[raceConditionExercise]] What is a race condition? Give a real
life example of one.
...
.  [[priorityInversionExercise]] What is priority inversion? Why can
