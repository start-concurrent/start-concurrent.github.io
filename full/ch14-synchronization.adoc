...
.  [[ex14-1]] What is the purpose of the
`synchronized` keyword? How does it work?
.  [[ex14-2]] The language specification for Java
...
.  [[ex14-6]] What is a race condition? Give a real
life example of one.
.  [[ex14-7]] Let's reexamine the code that
...
.  [[ex14-8]] Examine our deadlock example from
...
.  [[ex14-9]] What is priority inversion? Why can
...
. [[ex14-12]]The solution to the dining
...
*Experiments*
[start=13]
. [[ex14-13]] Critical sections can slow down
...
system.
. [[ex14-14]] Design a program which
...
. [[ex14-15]] Create an experiment to
