...
her left and the chopstick on her right. <<figure-dining>> shows
...
<<exercise13.10, Exercise 13.10>> two snippets of code could run
...
****
<<exercise14.6, Exercise 14.6>> +
<<exercise14.14, Exercise 14.14>>
****
...
****
<<exercise14.2, Exercise 14.2>> +
<<exercise14.7, Exercise 14.7>>
****
...
recall the threadstate diagram from <<ch13-concurrency#ch13-concurrency>>, there is a Not Runnable state which threads enter by
...
****
<<exercise14.3, Exercise 14.3>> +
<<exercise14.4, Exercise 14.4>>
****
...
[source, java, linenums]
----
include::{programsdir}/SynchronizedAccount.java[lines=18..33]
----
...
[source, java, linenums]
----
include::{programsdir}/SynchronizedAccount.java[lines=35..44]
----
...
[source, java, linenums]
----
include::{programsdir}/DeadlockPhilosopher.java[lines=10..20]
----
...
[source, java, linenums]
----
include::{programsdir}/DeadlockPhilosopher.java[lines=22..46]
----
====
...
[source, java, linenums]
----
include::{programsdir}/Deadlock.java[lines=1..7]
----
...
[source, java, linenums]
----
include::{programsdir}/Deadlock.java[lines=9..21]
----
...
[source, java, linenums]
----
include::{programsdir}/Deadlock.java[lines=23..25]
----
...
[source, java, linenums]
----
include::{programsdir}/Deadlock.java[lines=27..59]
----
...
implementation of matrix multiply given in <<matrixMultiplicationExample>> and use the `synchronized` keyword to lock on the
matrix itself.
...
In <<ch13-concurrency#ch13-concurrency>> we suggest that you use
...
****
<<exercise14.9, Exercise 14.9>> +
<<exercise14.15, Exercise 14.15>>
****
...
[source, java, linenums]
----
include::{programsdir}/DiningPhilosopher.java[lines=1..8]
----


We begin with the same setup as the deadlocking version given in
<<Deadlock>>. Unlike that example, we include a
...
[source, java, linenums]
----
include::{programsdir}/DiningPhilosopher.java[lines=10..27]
----
...
[source, java, linenums]
----
include::{programsdir}/DiningPhilosopher.java[lines=29..45]
----
...
[source, java, linenums]
----
include::{programsdir}/DiningPhilosopher.java[lines=47..70]
----
...
[source, java, linenums]
----
include::{programsdir}/DiningPhilosopher.java[lines=72..83]
----
...
****
<<exercise14.12, Exercise 14.12>>
****

=== Exercises
*Conceptual Problems*

1.  [[exercise14.1]] What is the purpose of the
`synchronized` keyword? How does it work?
2.  [[exercise14.2]] The language specification for Java
...
6.  [[exercise14.6]] What is a race condition? Give a real
life example of one.
7.  [[exercise14.7]] Let's reexamine the code that
...
8.  [[exercise14.8]] Examine our deadlock example from
...
9.  [[exercise14.9]] What is priority inversion? Why can
...
11. [[exercise14.11]] In <<bankAccountExample>>
...
12. [[exercise14.12]]The solution to the dining
...
+
*Experiments*
13. [[exercise14.13]] Critical sections can slow down
...
system.
14. [[exercise14.14]] Design a program which
...
15. [[exercise14.15]] Create an experiment to
